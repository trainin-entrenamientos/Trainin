  ...
  animations: [
    ...
    trigger('fadeZoomStagger', [
      transition('hidden => visible', [
        sequence([
          query('.marker-label, .fade-marker:not(.marker-label)', [
          ...
          query('.fade-marker:not(.marker-label)', [
            stagger(200, [
    ...
    trigger('sectionLift', [
      state('hidden', style({ opacity: 0, transform: 'translateY(60px) scale(0.97)' })),
...
export class InicioComponent implements AfterViewInit {
  ...
  @ViewChild('correctionSection', { static: true }) correctionSection!: ElementRef;
  @ViewChild('subscriptionSection', { static: true }) subscriptionSection!: ElementRef;
  ...
  ngAfterViewInit(): void {
    ...
    const observerCorrection = new IntersectionObserver(([entry]) => {
    ...
    const observerSubscription = new IntersectionObserver(([entry]) => {
